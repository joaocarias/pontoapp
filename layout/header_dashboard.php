...
use Lib\MenuDashboard;
use Lib\MenuUserDashboard; 
use App\Strings;
...
<html lang="pt-br">
  <head>       
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="/<?= $stringsArr['dashboard']->getLink() ?>"><?= TITULO_SISTEMA_COMPLETO ?></a>
...
<!--          </ul>
        ...
        <?php 
            ...
            $menuUser = new MenuUserDashboard();
            echo $menuUser->getMenuUser();
