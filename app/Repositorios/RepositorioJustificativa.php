...
use App\Interfaces\IRepositorioJustificativa;
use App\Models\Justificativa;
use App\Repositorios\RepositorioLogUpdate;
use App\Models\LogUpdate;

class RepositorioJustificativa implements IRepositorioJustificativa {
    ...
    public function insertJustificativa(Justificativa $obj) {
        $i = 0;
        $tabela = "tb_justificativa";
        
        $params = array(
                "id_funcionario" => $obj->getId_funcionario(),
                "data" => $obj->getData(),
                "hrs_justificadas" => $obj->getHrs_justificadas(),
                "txt_justificado" => $obj->getTxt_justificado(),
