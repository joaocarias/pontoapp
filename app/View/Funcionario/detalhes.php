                ...
                <div class="bs-component">                            
                    <div class="card mb-3 border-success">
                        ...
                        <div class="card-body">  
                            ...
                            <a class="card-link" href="/funcionario/exclusao" data-toggle="modal" data-target="#exampleModal" >Excluir</a> 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">                
                Tem certeza que deseja <strong>Excluir o Cadastro</strong>?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal">Cancelar</button>
                <a href="/funcionario/exclusao?id=<?=$funcionario->getId();?>" class="btn btn-warning ">Confirmar a Exclusão!</a>
            </div>
