...
if(isset($logado) && !is_null($logado) && $logado > 0){
    ...
    $app->get('/calendario/justificativa','App\Controllers\CalendarioController:justificativa');

    $app->post('/justificativa/cadastrar','App\Controllers\JustificativaController:cadastrar');
    $app->get('/justificativa/edicao','App\Controllers\JustificativaController:edicao');
    $app->post('/justificativa/editar','App\Controllers\JustificativaController:editar');
    $app->get('/justificativa/excluir','App\Controllers\JustificativaController:excluir');
}else{
